...
export default class Game {
    constructor(canvas) {
        ...
        // Tutorial system
        this.tutorial = new Tutorial(() => this.renderTutorialBackground());
    ...
    renderTutorialBackground() {
        // Set camera to center of the world (grass area) - same as game start
        this.camera.x = this.worldWidth / 2 - this.width / 2;
        this.camera.y = this.worldHeight / 2 - this.height / 2;
        
        // Generate trees and apples for the tutorial scene (if not already generated)
